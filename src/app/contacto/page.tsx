            ...
            <div className="space-y-6 w-full">
              ...
              <div className="bg-[#1a1a1a] p-6 rounded-lg shadow-lg border border-gray-800">
                ...
                <div className="flex gap-4">
                  {/* facebook */}
                  <a href="https://www.facebook.com/juansztern" className="w-10 h-10 rounded-full bg-[#8e44ad]/20 flex items-center justify-center text-[#8e44ad] hover:bg-[#8e44ad] hover:text-white transition-all">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
                      <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z" />
                    </svg>
                  </a>
                  {/* instagram */}
                  <a href="https://www.instagram.com/od.juansztern/" className="w-10 h-10 rounded-full bg-[#8e44ad]/20 flex items-center justify-center text-[#8e44ad] hover:bg-[#8e44ad] hover:text-white transition-all">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
                  ...
                  {/* linkedin */}
                  <a href="https://www.linkedin.com/in/odont%C3%B3logo-juan-m-sztern-948a68335/" className="w-10 h-10 rounded-full bg-[#8e44ad]/20 flex items-center justify-center text-[#8e44ad] hover:bg-[#8e44ad] hover:text-white transition-all">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
                  ...
                  <WhatsAppButton
                    size="sm"
                    position="static"
                    customClass="w-10 h-10 rounded-full bg-[#8e44ad]/20 text-[#8e44ad] hover:bg-[#8e44ad] hover:text-white"
                  />
                </div>
              </div>
            </div>
